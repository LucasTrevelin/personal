...
function landing() {
      ...
      <div className="introduction">
        ...
        <div className="headerContentContainer" style={{margin:"0"}}>
          ...
          <Paper elevation={5} style={{ backgroundColor: '#272c34', height: 'auto', width:'90%', margin:"auto" , 'border-radius': '30px', border:'3px solid grey', padding:'10px', overflow:"scroll", minWidth:'300px',}}> 
            <h1 style={{ color: 'yellow', 'margin': '20px 20px', textAlign:'center'}}>Quem sou eu?</h1>
          ...
          <Paper elevation={5} style={{ backgroundColor: '#272c34', height: '90%', width:'90%', margin:"auto" , 'border-radius': '30px', border:'3px solid grey', padding:'10px', overflow:"hidden", minWidth:'300px',}}> 
    ...
    <body style={{'background':'linear-gradient(0deg, rgba(8,8,8,0.6544818611038166) 0%, rgba(0,0,0,0.8701681356136204) 69%, rgba(0,0,0,1) 100%)', 'width':'100vw', height:'212vh'}}>
    </body>
    <footer  className="footer">
      <IconButton className="button1" >
        <Mail/>
      </IconButton>
      <IconButton className="button2">
        <LinkedIn/>
      </IconButton>
      <IconButton className="button3">
        <Git/>
      </IconButton>
      <IconButton className="button3">
      <ExploreIcon/>
      </IconButton>
      <IconButton className="button4">
      <Download/>
      </IconButton>
    </footer>
